...
const messages = [
    ...
    { text: "Trung Thu này, có Nhi là đủ tiểu đường hơn mọi loại bánh 🍰", img: "./style/img/Anh (3).jpg" }, 
    { text: "Chị Nhi xinh đẹp ơi, có muốn cùng ta đi chơi không nè 😤", img: "./style/img/Anh (4).jpg" }, 
    ...
    { text: "Em chính là chiếc lồng đèn đặc biệt nhất của anh, Nhi ạ 💕", img: "./style/img/Anh (5).jpg" }, 
    { text: "Trung Thu này không cần nhiều, chỉ cần Nhi thoai 😘", img: "./style/img/Anh (6).jpg" }, 
